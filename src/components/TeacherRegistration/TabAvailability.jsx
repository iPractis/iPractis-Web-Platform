...
const TabAvailability = ({ activeTab }) => {
  return (
    <div className={`${activeTab !== 3 && "hidden"}`}>
      <SectionHeader
        descriptionText="Set your availability to let students know when you're free for lessons and manage your schedule effectively."
        titleIcon={<CalendarIcon fillColor={"fill-primary-color-P1"} />}
        wrapperSectionHeaderClassName={"p-4 mb-[50px]"}
        titleText="Availability section"
