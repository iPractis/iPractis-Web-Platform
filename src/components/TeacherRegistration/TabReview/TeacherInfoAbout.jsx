  ...
  return (
    <article className="px-4">
      ...
      <ul className="sm:hidden flex items-center gap-2.5 mt-5">
        { draftData.languages && draftData.languages.length > 0 ? draftData.languages.map((language, index) => (
          ...
          <li className="ST-3 text-primary-color-P4">Languages not provided yet</li>
        )}
      </ul>
