...
import { PersonIcon, StarIcon, HeartSmallIcon, UserSpeakingIcon, UserHatIcon, ChevronLeftBigIcon, ChevronRightMediumIcon, CircleImportantIcon, ChevronRightIcon, FlagIcon, TeacherInfoIcon, IncreasingLevels, GraduationCapIcon, DollarSignIcon, ManIcon, MaleIcon, NewMessageCustomIcon, NewMessageIcon, MessageIcon, RightArrowBiggerIcon, RightArrowMediumIcon, CalendarIcon, GraphImportantIcon, ChevronDownBigIcon } from "../../Icons";
    ...
    <form onSubmit={handleSendApplication}>
      <section className="max-w-[1400px] mx-auto gap-[50px]">
        ...
        <div className="bg-primary-color-P12 rounded-[32px] p-0 mb-8 max-w-[1000px] h-[48px] flex items-center justify-between px-8 mx-auto">
          ...
          <div className="flex items-center gap-[10px]">
            ...
            <div className="flex flex-col justify-center">
              <h3 className="MT-SB-1 text-primary-color-P4">{draftData.firstName} {draftData.lastName ? `${draftData.lastName.charAt(0).toUpperCase()}.` : ''}</h3>
              <div className="flex items-center gap-2">
                <Image
                  ...
                  unoptimized={true}
                />
                <p className="ST-2 text-primary-color-P4">Teaches {draftData.subject}</p>
              </div>
            </div>
          </div>
        ...
        <div className="w-[1000px] h-[302.625px] max-w-[1000px] flex gap-8 mb-8 mx-auto">
          ...
          <div className="w-[430px] h-[302.625px] max-w-[430px] flex flex-col justify-between py-5">
            ...
            <div className="flex gap-2">
              ...
              <div className="w-[170px] h-[50px] bg-[#F8F7F5] rounded-[16px] flex gap-3 items-center px-2">
                ...
                <div>
                  <h4 className="ST-1 text-primary-color-P4">{draftData.totalLessons || ''} Lessons</h4>
                  <div className="flex items-center gap-1">
                    <span className={draftData.totalLessons ? "MT-SB-1 text-primary-color-P1" : "ST-3 text-primary-color-P1"}>
              ...
              <div className="w-[170px] h-[50px] bg-[#F8F7F5] rounded-[16px] flex gap-3 items-center px-2">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-1">
                    <span className={draftData.activeStudents ? "MT-SB-1 text-primary-color-P1" : "ST-3 text-primary-color-P1"}>
              ...
              {draftData.hourlyPrice && (
                <div className="w-[250px] h-[50px] bg-[#F8F7F5] rounded-[16px] flex gap-3 items-center px-2">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-1">
                      <span className="ST-SB-3 text-primary-color-P1">{draftData.hourlyPrice} USD</span>
                      <span className="bg-quaternary-color-A6 text-primary-color-P1 px-[8px] py-[2px] rounded-[6px] ST-1 flex items-center justify-center">30 mins</span>
                    </div>
                  </div>
                </div>
              )}
            ...
            <div className="w-[430px] h-[48px] flex items-center gap-4">
              {/* Message Icon */}
              <button className="w-[48px] h-[48px] rounded-[16px] bg-tertiary-color-SC5 hover:bg-[#3b5be6] transition-colors flex items-center justify-center p-[14px]" type="button">
                <MessageIcon fillcolor="fill-primary-color-P12"/>
              </button>

              {/* Try Now Button */}
              <button className="w-[366px] h-[48px] bg-tertiary-color-SC6 hover:bg-tertiary-color-SC5 transition-colors flex items-center justify-between pl-4 pr-[6px] py-3 rounded-[16px]" type="button">
                <span className="text-primary-color-P12 font-semibold">Try now!</span>
                 ...
                 <p className="ST-3 text-primary-color-P4 leading-relaxed">
                   ...
                   <div className="flex gap-[10px] items-center justify-start">
                     ...
                     <div key={index} className="flex items-center gap-1">
                       <span className="ST-2 text-primary-color-P1">{language.name}</span>
                       <div className={`rounded-[6px] px-[6px] py-[2px] ST-1 flex items-center justify-center ${getLevelColor(language.level)} ${language.level === 'Native' ? 'text-primary-color-P12' : 'text-primary-color-P1'}`}>
        ...
        <div className="bg-primary-color-P12 rounded-[32px] p-4 mb-8 h-[48px] flex items-center gap-[10px] max-w-none w-[calc(100%+160px)] md:w-[calc(100%+120px)] sm:w-[calc(100%+48px)] ml-[-80px] md:ml-[-50px] sm:ml-[-20px]">
          ...
          <div className="flex flex-col justify-center">
            ...
            <p className="ST-3 text-primary-color-P4">Real-time visibility into the teacher’s scheduling patterns and open time slots.</p>
          </div>
        </div>
        ...
        <div className="w-[1000px] max-w-[1000px] mx-auto mb-8 bg-white rounded-[32px] p-8 flex flex-col gap-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="w-[430px] h-[48px] bg-[#F8F7F5] rounded-full px-3 py-2 flex items-center gap-2">
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w.org/2000/svg">
